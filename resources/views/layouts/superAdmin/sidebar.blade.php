<nav class="pcoded-navbar">
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class=" ">
                <a href="sticky.htm">
                    ...
                    <span class="pcoded-mtext">Quản lý người bán</span>
                </a>
            </li>
        </ul>
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="">
                <a href="superAdmin/extra-pages/landingpage/index.htm" target="_blank">
            ...
            <li class="pcoded-hasmenu ">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class="pcoded-hasmenu ">
                        ...
                        <ul class="pcoded-submenu">
                            <li class="">
                                <a href="superAdmin/extra-pages/email-templates/email-welcome.htm">
                                    <span class="pcoded-mtext">Welcome Email</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="superAdmin/extra-pages/email-templates/email-password.htm">
                                    <span class="pcoded-mtext">Reset Password</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="superAdmin/extra-pages/email-templates/email-newsletter.htm">
                                    <span class="pcoded-mtext">Newsletter Email</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="superAdmin/extra-pages/email-templates/email-launch.htm">
                                    <span class="pcoded-mtext">App Launch</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="superAdmin/extra-pages/email-templates/email-activation.htm">
