                ...
                <div class="card-block">
                    <div class="table-responsive">
                        <table class="table table-hover table-borderless">
                            ...
                            <tbody>
                            <tr>
                                <td><img src="{{ asset('superAdmin/assets/images/widget/GERMANY')}}" alt="" class="img-fluid img-30"></td>
                                <td>Germany</td>
                                <td>3,562</td>
                                <td class="text-right">56.23%</td>
                            </tr>
                            <tr>
                                <td><img src="{{ asset('superAdmin/assets/images/widget/USA')}}" alt="" class="img-fluid img-30"></td>
                                <td>USA</td>
                                <td>2,650</td>
                                <td class="text-right">25.23%</td>
                            </tr>
                            <tr>
                                <td><img src="{{ asset('superAdmin/assets/images/widget/AUSTRALIA')}}" alt="" class="img-fluid img-30"></td>
                                <td>Australia</td>
                                <td>956</td>
                                <td class="text-right">12.45%</td>
                            </tr>
                            <tr>
                                <td><img src="{{ asset('superAdmin/assets/images/widget/UK')}}" alt="" class="img-fluid img-30"></td>
                                <td>United Kingdom</td>
                                <td>689</td>
                                <td class="text-right">8.65%</td>
                            </tr>
                            <tr>
                                <td><img src="{{ asset('superAdmin/assets/images/widget/BRAZIL')}}" alt="" class="img-fluid img-30"></td>
                                <td>Brazil</td>
                                <td>560</td>
        ...
        <div class="col-xl-8 col-md-12">
            <div class="card social-network">
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="{{ asset('superAdmin/assets/images/widget/icon-1.png')}}" alt=" " class="img-responsive p-b-20">
                            <div class="row">
                                <div class="col-5">
                        ...
                        <div class="col-sm-6">
                            <img src="{{ asset('superAdmin/assets/images/widget/icon-2.png')}}" alt=" " class="img-responsive p-b-20">
                            <div class="row">
                                <div class="col-5">
                    ...
                    <div class="row">
                        <div class="col-sm-6 m-t-0">
                            <img src="{{ asset('superAdmin/assets/images/widget/icon-3.png')}}" alt=" " class="img-responsive p-b-10 p-t-10">
                            <div class="row">
                                <div class="col-5">
                        ...
                        <div class="col-sm-6 m-t-0">
                            <img src="{{ asset('superAdmin/assets/images/widget/icon-4.png')}}" alt=" " class="img-responsive p-b-10 p-t-10">
                            <div class="row">
                                <div class="col-5">
                                    <p class="text-muted m-b-5">Tweets :</p>
                                </div>
